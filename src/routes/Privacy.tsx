...
export default function Privacy() {
	return (
		<>
			...
			<p>
				MAS Agility League ("us", "we", or "our") operates the
			...
			<p>
				...
				Policy for MAS Agility League is created with the help of the{' '}
				<a href="https://privacypolicies.com/">
			...
			<p>
				...
				Service. You can learn more how to manage cookies in the{' '}
			...
			<p>
				MAS Agility League uses the collected data for various purposes:
			</p>
			<ul>
			...
			<p>
				MAS Agility League will take all steps reasonably necessary to
			...
			<p>
				MAS Agility League may disclose your Personal Data in the good
				faith belief that such action is necessary to:
			</p>
			<ul>
				<li>To comply with a legal obligation</li>
				<li>
					To protect and defend the rights or property of MAS Agility
					League
				</li>
				<li>
